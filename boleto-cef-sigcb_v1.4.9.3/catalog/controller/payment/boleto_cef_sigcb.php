...
class ControllerPaymentBoletocefsigcb extends Controller {
	protected function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/boleto_cef_sigcb.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/payment/boleto_cef_sigcb.tpl';
		} else {
			$this->template = 'default/template/payment/boleto_cef_sigcb.tpl';
		}	
	...
	public function confirm() {
		...
		$this->model_checkout_order->confirm($this->session->data['order_id'], $this->config->get('boleto_cef_sigcb_order_status_id'), $comment);
	}
