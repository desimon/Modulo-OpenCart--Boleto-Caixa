...
$nnum55 = formata_numero($dadosboleto["nosso_numero_const1"],1,0).formata_numero($dadosboleto["nosso_numero_const2"],1,0)."/".formata_numero($dadosboleto["nosso_numero1"],3,0).formata_numero($dadosboleto["nosso_numero2"],3,0).formata_numero($dadosboleto["nosso_numero3"],9,0);
$nossonumero = $nnum55 ."-". digitoVerificador_nossonumero($nnum2);
...
//Guarda inicial
$rresponta ='<img src=boleto/imagens/p.png width='.$fino.' height='.$altura.' border=0><img 
...
while (strlen($texto) > 0) {
  ...
  for($i=1;$i<11;$i+=2){
    ...
    $rresponta .= 'src=boleto/imagens/p.png width='.$f1.' height='.$altura.' border=0><img ';
    ...
    $rresponta .='src=boleto/imagens/b.png width='.$f2.' height='.$altura.' border=0><img ';
...
$rresponta .='src=boleto/imagens/p.png width='.$largo.' height='.$altura.' border=0><img 
src=boleto/imagens/b.png width='.$fino.' height='.$altura.' border=0><img 
